      ...
      <div className="px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {features?.map((feature, index) => (
            <div
              key={index}
              className={`group relative p-8 border border-gray-200 bg-white transition-all duration-300 hover:shadow-2xl hover:border-primary hover:shadow-gray-200/50 hover:-translate-y-2 `}
            >
              {/* Icon Container */}
